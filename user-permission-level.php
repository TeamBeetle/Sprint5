...
<head>
    ...
    <link href="admin-page-styles.css?v=37" rel="stylesheet" type="text/css" />
</head>
<!-- Page body -->
<body>
<!-- Nav Bar -->
...
<!--end contact form-->
<div class='change-permission-container'>
    <?php
    ...
    if ($current_permission_level == 1) {
        ...
        echo "<div class='delete-message'>
                    <h1> The user with the identification number $receivedValue has been removed as admin</h1>
                </div>";
    } elseif ($current_permission_level == 0) {
        @mysqli_query($cnxn, $sql_make_admin);
        echo "<div class='delete-message'>
                    <h1> The user with the identification number $receivedValue has been added as an admin</h1>
                </div>";
    }
    ?>
</div>
