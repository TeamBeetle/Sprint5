...
<!-- Meta data -->
    <head>
        ...
        <link href="admin-page-styles.css?v=22" rel="stylesheet" type="text/css" />
    </head>
    <!-- Page body -->
    <body>
        <!-- Nav Bar -->
        ...
        <div class='delete-message'>
            ...
            $sql2 = "INSERT INTO `user_data_bin`
        SELECT *
        FROM `user_data`
        WHERE `uid` = '$receivedValue';";

            @mysqli_query($cnxn, $sql2);

            @mysqli_query($cnxn, $sql);
            echo "<h1>Deleted User with the ID: $receivedValue</h1>";
            ?>
        </div>
